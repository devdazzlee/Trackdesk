...
export class MenuCustomizationModel {
  ...
  static async listMenuItems(accountId: string, filters: any = {}): Promise<MenuItem[]> {
  ...
  static async getMenuTree(accountId: string, parentId?: string): Promise<MenuItem[]> {
    const items = await this.listMenuItems(accountId);
    return this.buildMenuTree(items, parentId);
  }

  private static buildMenuTree(items: MenuItem[], parentId?: string): MenuItem[] {
    return items
  ...
  static async createMenuStructure(data: Partial<MenuStructure>): Promise<MenuStructure> {
  ...
  static async findMenuStructureById(id: string): Promise<MenuStructure | null> {
    return await prisma.menuStructure.findUnique({
      where: { id }
    }) as MenuStructure | null;
  }

  static async findMenuStructureByType(accountId: string, type: string): Promise<MenuStructure | null> {
  ...
  static async updateMenuStructure(id: string, data: Partial<MenuStructure>): Promise<MenuStructure> {
  ...
  static async listMenuStructures(accountId: string, filters: any = {}): Promise<MenuStructure[]> {
    const where: any = { accountId };
  ...
  static async createMenuTemplate(data: Partial<MenuTemplate>): Promise<MenuTemplate> {
  ...
  static async updateMenuTemplate(id: string, data: Partial<MenuTemplate>): Promise<MenuTemplate> {
  ...
  static async listMenuTemplates(accountId: string, filters: any = {}): Promise<MenuTemplate[]> {
    const where: any = { accountId };
  ...
  static async applyMenuTemplate(templateId: string, accountId: string): Promise<MenuStructure> {
  ...
  static async checkMenuPermission(menuItemId: string, userId: string, userRole: string): Promise<boolean> {
  ...
  static async grantMenuPermission(menuItemId: string, userId?: string, role?: string, permission: string = 'VIEW'): Promise<MenuPermission> {
  ...
  static async revokeMenuPermission(menuItemId: string, userId?: string, role?: string): Promise<void> {
  ...
  static async getMenuPermissions(menuItemId: string): Promise<MenuPermission[]> {
    return await prisma.menuPermission.findMany({
      where: { menuItemId }
    }) as MenuPermission[];
  }

  static async getVisibleMenuItems(accountId: string, userId: string, userRole: string, menuType: string): Promise<MenuItem[]> {
  ...
  static async reorderMenuItems(accountId: string, itemOrders: Array<{ id: string; order: number; parentId?: string }>): Promise<void> {
  ...
  static async duplicateMenuItem(menuItemId: string, newParentId?: string): Promise<MenuItem> {
  ...
  static async createDefaultMenuStructures(accountId: string): Promise<MenuStructure[]> {
