    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                if (!token) {
                    token = ((_a = req.cookies) === null || _a === void 0 ? void 0 : _a.accessToken) || ((_b = req.cookies) === null || _b === void 0 ? void 0 : _b.token);
                }
                if (!token) {
            ...
            case 2:
                ...
                req.user = {
                    ...
                    affiliateId: (_c = user.affiliateProfile) === null || _c === void 0 ? void 0 : _c.id,
                    userId: user.id,
...
var requireAffiliate = function (req, res, next) {
    if (!req.user) {
        return res.status(401).json({ error: "Authentication required" });
    }
...
var setAuthCookies = function (res, token, user) {
    ...
    res.cookie("userData", JSON.stringify(userData), __assign(__assign({}, exports.COOKIE_CONFIG), { httpOnly: false }));
};
