      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600">
            Monitor and analyze website performance across all your properties
          </p>
        </div>
      ...
      {showAddWebsite && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Add a new website to track with Trackdesk
            </CardDescription>
          </CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {websites
                .reduce((sum, site) => sum + site.pageViews, 0)
                .toLocaleString()}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {websites
                .reduce((sum, site) => sum + site.uniqueVisitors, 0)
                .toLocaleString()}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {(
                websites.reduce((sum, site) => sum + site.conversionRate, 0) /
                websites.length
              ).toFixed(1)}
              %
            </div>
      ...
      <Tabs defaultValue="websites" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <DataTable
                ...
                description="Monitor and manage your tracked websites"
        ...
        <TabsContent value="analytics" className="space-y-6">
          ...
          <BarChartComponent
            ...
            dataKey="page"
            xAxisKey="page"
            bars={[{ dataKey: "views", fill: "#3b82f6", name: "Page Views" }]}
          />
        </TabsContent>
        ...
        <TabsContent value="realtime" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Real-time events from all your websites
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="settings" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Copy and paste this code into your website to start tracking
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure what data to collect from your websites
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-slate-500">
                      Monitor page visits and navigation
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-slate-500">
                      Monitor user interactions and clicks
                    </div>
                  </div>
                  <input type="checkbox" defaultChecked className="h-4 w-4" />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-slate-500">
                      Protect user privacy by anonymizing IPs
                    </div>
                  </div>
